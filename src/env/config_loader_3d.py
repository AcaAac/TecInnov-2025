...
def get_default_config_path(profile: str = "train") -> Path:
    ...
    return _project_root() / "configs" / f"{profile_normalized}_3d.yaml"
...
def _validate_and_build(data: Dict[str, Any]) -> Env3DConfig:
    ...
    return Env3DConfig(**normalized)


def load_env_config_3d(
    profile: str = "train",
